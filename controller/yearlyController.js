...
module.exports = function (req, res, next) {
    ...
    const result = fetch(url)
        ...
        .then((text) => {
            ...
            const jsonObject = { title: horoscopeList[horoscopeName][0].turkishToUpper() + horoscopeList[horoscopeName].slice(1) + " Burcu Yıllık Yorum", content: htmlContent[1].textContent.replace(/\n/g, "").replaceAll("&rsquo;", "'").replaceAll("&ouml;", "ö").replaceAll("&uuml;", "ü").replaceAll("&ccedil;", "ç") };
